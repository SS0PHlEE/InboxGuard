...
export default function Home() {
  ...
  return <main>
    ...
    <footer><div className="container footer-content"><Link className="brand" href="/"><span>✦</span> inboxguard</Link><p>Pause. Check. Decide.</p><Link href="/ask">Cyber Helper →</Link></div></footer>
  </main>;
}
