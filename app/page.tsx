...
export default function Home() {
  ...
  return <main>
    ...
    <footer><div className="container footer-content"><Link className="brand" href="/"><span>✦</span> inboxguard</Link><p>Pause. Check. Decide.</p><div className="footer-links"><Link href="/privacy">Privacy Policy</Link><Link href="/terms">Terms of Service</Link><Link href="/ask">Cyber Helper →</Link></div></div></footer>
  </main>;
}
